...
create or replace function public.get_user_content_recommendations(business_id_param uuid default auth.uid())
returns table (
    keyword text,
...
begin
    ...
    select * from get_next_content_recommendation(business_id_param);
